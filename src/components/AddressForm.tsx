        ...
        <div onClick={resetForm} className="fixed inset-0 z-50 flex-center p-4">
            <form onClick={e=> e.stopPropagation()} onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 w-full max-w-lg animate-fade-in">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="bloxk text-sm font-medium text-app-green mb-1.5">Label</label>
                    ...
                    <div>
                        <label className="bloxk text-sm font-medium text-app-green mb-1.5">Street Address</label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="bloxk text-sm font-medium text-app-green mb-1.5">City</label>
                        ...
                        <div>
                            <label className="bloxk text-sm font-medium text-app-green mb-1.5">State</label>
